...
public class MethodsInsideMethod {
	...
	// We learn from here, which concept will be used later // We can call one or more than one method, inside another method 	// This method can be void type too
	...
	public static void main(String[] args) {
		MethodsInsideMethod mm = new MethodsInsideMethod();
		mm.dogDescription();
